    ...
    public class CategoriaCommandController extends GenericController<CategoriaDTO, CrearCategoriaDTO,
            ActualizarCategoriaDTO, UUID> {

        protected CategoriaCommandController(GenericService<CategoriaDTO, CrearCategoriaDTO, ActualizarCategoriaDTO,
                UUID> genericService) {
