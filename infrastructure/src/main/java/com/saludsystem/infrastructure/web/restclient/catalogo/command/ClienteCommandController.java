...
public class ClienteCommandController extends GenericController<ClienteDTO, CrearClienteDTO, ActualizarClienteDTO, UUID> {

    protected ClienteCommandController(
