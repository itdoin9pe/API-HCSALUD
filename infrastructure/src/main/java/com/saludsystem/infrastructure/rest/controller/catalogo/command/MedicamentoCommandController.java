...
public class MedicamentoCommandController extends GenericController<MedicamentoDTO, CrearMedicamentoDTO,
        ActualizarMedicamentoDTO, UUID> {

    protected MedicamentoCommandController(GenericService<MedicamentoDTO, CrearMedicamentoDTO, ActualizarMedicamentoDTO, UUID> genericService) {
