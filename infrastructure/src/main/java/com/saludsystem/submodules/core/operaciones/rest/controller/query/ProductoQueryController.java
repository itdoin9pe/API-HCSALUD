...
public class ProductoQueryController
{
	...
	public ProductoQueryController(
		ProductoAllHandler allHandler,
		ProductoListHandler listHandler,
		ProductoByIdHandler byIdHandler)
	{
	...
	@ApiResponses(value =
	{ @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Operación exitosa", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProductoListResponse.class))) })
