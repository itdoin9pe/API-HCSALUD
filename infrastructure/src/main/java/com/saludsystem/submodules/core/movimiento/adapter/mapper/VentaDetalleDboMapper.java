...
public class VentaDetalleDboMapper
{
	...
	{
		return new VentaDetalle(entity.getVentaDetalleId(), entity.getVentaEntity().getVentaId(),
				entity.getProductoEntity().getProductoId(), entity.getCodigoProducto(), entity.getCantidad(),
				entity.getPrecio(), entity.getSubtotal());
	}
}