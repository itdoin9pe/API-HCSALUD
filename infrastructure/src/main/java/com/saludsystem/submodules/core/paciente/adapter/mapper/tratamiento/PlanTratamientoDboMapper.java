...
public class PlanTratamientoDboMapper
{
	...
	{
		return new PlanTratamiento(entity.getPacientePlanTratamientoId(), entity.getPacienteEntity().getPacienteId(),
				entity.getDoctorEntity().getDoctorId(), entity.getEspecialidadEntity().getEspecialidadId(),
				entity.getMedidaEntity().getMedidaId(), entity.getFechaInicio(), entity.getFechaFin());
	}
}
