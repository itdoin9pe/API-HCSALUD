...
public class EstudioMedicoDboMapper
{
	...
	{
		return new EstudioMedico(entity.getId(), entity.getTipo(), entity.getDescripcion(), entity.getEstado(),
				entity.getPacienteEntity().getPacienteId(), entity.getDoctorEntity().getDoctorId(),
