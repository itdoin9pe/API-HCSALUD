...
public class AlmacenQueryController
{
	...
	public AlmacenQueryController(
		AlmacenAllHandler allHandler,
		AlmacenByIdHandler byIdHandler,
	...
	@GetMapping("/GetAll")
	@ApiResponses(value =
	{ @ApiResponse(responseCode = "200", description = "Operación exitosa", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AlmacenListResponse.class))) })
