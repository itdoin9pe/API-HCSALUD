...
public class TipoConceptoBean
{
	...
	@Bean
	public TipoConceptoEditService tipoConceptoEditService(TipoConceptoDao dao, TipoConceptoRepository repository)
	{
		return new TipoConceptoEditService(dao, repository);
	}

	@Bean
	public TipoConceptoDeleteService tipoConceptoDeleteService(TipoConceptoRepository repository, TipoConceptoDao dao)
	{
