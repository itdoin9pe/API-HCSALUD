...
public class PermisoQueryController
{
	...
	public PermisoQueryController(
		PermisoAllHandler allHandler,
		PermisoListHandler listHandler,
		PermisoByIdHandler byIdHandler)
	{
	...
	@GetMapping("/GetAll")
	@ApiResponses(value =
	{ @ApiResponse(responseCode = "200", description = "Operación exitosa", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PermisoListResponse.class))) })
	public ListResponse<PermisoDTO> getAllPaginated(
