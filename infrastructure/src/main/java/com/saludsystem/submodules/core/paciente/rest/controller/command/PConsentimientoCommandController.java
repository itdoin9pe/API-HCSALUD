...
public class PConsentimientoCommandController {
    ...
    public PConsentimientoCommandController(PConsentimientoCreateHandler createHandler, PConsentimientoEditHandler editHandler, PConsentimientoDeleteHandler deleteHandler) {
