...
public class PlanTratamientoQueryController {
    ...
    public PlanTratamientoQueryController(PlanTratamientoListHandler listHandler, PlanTratamientoByIdHandler byIdHandler, PlanTratamientoAllHandler allHandler) {
