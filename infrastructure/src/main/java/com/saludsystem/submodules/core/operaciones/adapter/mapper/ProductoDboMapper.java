...
public class ProductoDboMapper {
    ...
    public static Producto toDomain(ProductoEntity domain) {
        return new Producto(domain.getProductoId(), domain.getMarcaEntity().getMarcaMaterialesId(),
                ...
                domain.getCodigo(), domain.getCodigoBarras(), domain.getNombre(), domain.getDescripcion(), 
                domain.getPrecioCompra(),domain.getPrecioVenta(), domain.getStock(), domain.getLote(), domain.getFecha(),
