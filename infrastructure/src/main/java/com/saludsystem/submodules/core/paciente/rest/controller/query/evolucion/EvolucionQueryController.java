...
public class EvolucionQueryController
{
	...
	public EvolucionQueryController(
		EvolucionListHandler listHandler,
		EvolucionByIdHandler byIdHandler,
		EvolucionAllHandler allHandler)
	{
	...
	@GetMapping("/GetAll")
	@ApiResponses(value =
	{ @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Operación exitosa", content = @Content(mediaType = "application/json", schema = @Schema(implementation = EvolucionListResponse.class))) })
