...
public class ConsentimientoQueryController
{
	...
	public ConsentimientoQueryController(
		ConsentimientoByIdHandler byIdHandler,
		ConsentimientoAllHandler allHandler,
		ConsentimientoListHandler listHandler)
	{
	...
	@GetMapping("/GetAll")
	@ApiResponses(value =
	{ @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Operación exitosa", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ConsentimientoListResponse.class))) })
