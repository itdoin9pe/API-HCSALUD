...
public class PresentacionQueryController {
    ...
    public PresentacionQueryController(PresentacionAllHandler allHandler, PresentacionByIdHandler byIdHandler, PresentacionListHandler listHandler) {
    ...
    public ListResponse<PresentacionDTO> getAllPaginated(@RequestParam UUID hospitalId,
