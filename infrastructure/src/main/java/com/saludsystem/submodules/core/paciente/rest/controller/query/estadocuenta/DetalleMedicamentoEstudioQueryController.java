...
public class DetalleMedicamentoEstudioQueryController
{
	...
	public DetalleMedicamentoEstudioQueryController(
		DetalleMedicamentoEstudioListHandler listHandler,
		DetalleMedicamentoEstudioByIdHandler byIdHandler,
		DetalleMedicamentoEstudioAllHandler allHandler)
	{
	...
	@GetMapping("/GetAll")
	@ApiResponses(value =
	{ @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Operación exitosa", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DetalleMedicamentoEstudioListResponse.class))) })
