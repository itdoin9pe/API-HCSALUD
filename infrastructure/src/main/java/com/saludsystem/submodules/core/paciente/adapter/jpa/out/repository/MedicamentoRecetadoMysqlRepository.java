...
public class MedicamentoRecetadoMysqlRepository implements MedicamentoRecetadoRepository
{
	...
	public MedicamentoRecetadoMysqlRepository(
		MedicamentoRecetadoJpaRepository medicamentoRecetadoJpaRepository,
	...
	public MedicamentoRecetado save(MedicamentoRecetado medicamentoRecetado)
	{
		...
		MedicamentoRecetadoEntity entity = MedicamentoRecetadoDboMapper.toEntity(medicamentoRecetado, userId,
				hospitalId);
