...
public class TipoTarjetaBean
{
	...
	@Bean
	public TipoTarjetaEditService tipoTarjetaEditService(TipoTarjetaDao dao, TipoTarjetaRepository repository)
	{
		return new TipoTarjetaEditService(dao, repository);
	}

	@Bean
	public TipoTarjetaDeleteService tipoTarjetaDeleteService(TipoTarjetaRepository repository, TipoTarjetaDao dao)
	{
