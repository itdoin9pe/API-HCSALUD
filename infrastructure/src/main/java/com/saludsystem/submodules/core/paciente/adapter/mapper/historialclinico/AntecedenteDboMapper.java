...
public class AntecedenteDboMapper
{
	...
	{
		return new Antecedente(entity.getPacienteEnfermedadActualId(), entity.getPacienteEntity().getPacienteId(),
				entity.getMotivo(), entity.getEnfermedad(), entity.getTiempoEnfermedad(), entity.getSigno(),
				entity.getRelato(), entity.getFunciones(), entity.getAntecedentesPersonales(),
				entity.getAntecedentesFamiliares(), entity.getMedicamento(), entity.getNombreMedicamento(),
				entity.getMotivoMedicamento(), entity.getDosis());
	}
}
