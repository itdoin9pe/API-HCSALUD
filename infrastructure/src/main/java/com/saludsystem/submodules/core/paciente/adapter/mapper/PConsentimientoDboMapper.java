...
public class PConsentimientoDboMapper
{
	...
	{
		return new PacienteConsentimiento(entity.getPacienteConsentimientoId(),
				entity.getPacienteEntity().getPacienteId(), entity.getConsentimientoEntity().getConsentimientoId(),
				entity.getCuerpo(), entity.getFecha(), entity.getHora(), entity.getApoderadoNombre(),
				entity.getApoderadoDocumento(), entity.getApoderadoDireccion(),
				entity.getDoctorEntity() != null ? entity.getDoctorEntity().getDoctorId() : null, entity.getEstado(),
				entity.getFirma());
	}
}
