...
public class DiagnosticoPacienteQueryController {
	 ...
	 * @param listHandler
	 */
	public DiagnosticoPacienteQueryController(DiagnosticoAllHandler allHandler, DiagnosticoByIdHandler byIdHandler,
    ...
    public ListResponse<DiagnosticoDTO> getAllPaginated(@RequestParam UUID hospitalId,
