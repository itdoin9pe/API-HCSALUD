...
public class AseguradoraQueryController
{
	...
	public AseguradoraQueryController(
		AseguradoraAllHandler allHandler,
		AseguradoraListHandler listHandler,
		AseguradoraByIdHandler byIdHandler)
	{
	...
	@GetMapping("/GetAll")
	@ApiResponses(value =
	{ @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Operación exitosa", content = @Content(mediaType = "application/json", schema = @Schema(implementation = AseguradoraListResponse.class))) })
	public ListResponse<AseguradoraDTO> getAllPaginated(
