...
public class EstadoCuentaDboMapper
{
	...
	public static EstadoCuenta toDomain(EstadoCuentaEntity entity)
	{
		...
		return new EstadoCuenta(entity.getPec_estadoCuentaId(),
				entity.getPacienteEntity() != null ? entity.getPacienteEntity().getPacienteId() : null,
				entity.getFechaApertura(), entity.getEstado(), entity.getTotalHospitalizacion(),
				entity.getTotalMedicamentosEstudios(), entity.getTotalPagado(), entity.getSaldoPendiente(),
				mapCostosHospitalizacion(entity.getCostosHospitalizacion()),
				mapDetallesMedicamentosEstudios(entity.getDetallesMedicamentosEstudios()), mapPagos(entity.getPagos()));
	}
