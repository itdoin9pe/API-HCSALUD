...
public class ProcedimientoBean {
    ...
    @Bean
    public ProcedimientoEditService procedimientoEditService(
            ProcedimientoDao dao, ProcedimientoRepository repository) {
    ...
    public ProcedimientoDeleteService procedimientoDeleteService(
            ProcedimientoRepository repository, ProcedimientoDao dao) {
