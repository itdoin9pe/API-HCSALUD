...
public class PConsentimientoQueryController {
    ...
    public PConsentimientoQueryController(PConsentimientoAllHandler allHandler, PConsentimientoByIdHandler byIdHandler, PConsentimientoListHandler listHandler) {
