...
public class CostoHospitalizacionMysqlRepository implements CostoHospitalizacionRepository {
    ...
    public CostoHospitalizacionMysqlRepository(CostoHospitalizacionJpaRepository costoHospitalizacionJpaRepository, AuthenticateUserPort authenticateUserPort) {
    ...
    public CostoHospitalizacion save(CostoHospitalizacion costoHospitalizacion) {
        ...
        CostoHospitalizacionEntity entity = CostoHospitalizacionDboMapper
                .toEntity(costoHospitalizacion, hospitalId, userId);
