...
public class DiagnositcoCommandController
{
	...
	public DiagnositcoCommandController(
		EnfermedadCreateHandler createHandler,
		EnfermedadEditHandler editHandler,
		EnfermedadDeleteHandler deleteHandler)
	{
	...
	public ApiResponse update(
		@PathVariable String enfermedadId,
		@RequestBody EnfermedadEditCommand enfermedadEditCommand)
	{
	...
	/*
	 * @GetMapping("/GetEnfermedadFiltradosPorRol") public
	 * ResponseEntity<List<EnfermedadDTO>> getEnfermedadFiltradosPorRol() { return
	 * ResponseEntity.ok(enfermedadService.getEnfermedadFiltradosPorRol()); }
	 */
}