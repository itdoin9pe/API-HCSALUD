...
import com.saludsystem.submodules.mantenimiento.constant.EnfermedadConstant;
...
public class DiagnositcoCommandController {
    ...
    public ApiResponse stored(@Valid @RequestBody CrearEnfermedadDTO crearEnfermedadDTO) {
        createHandler.execute(crearEnfermedadDTO);
    ...
    public ApiResponse update(@PathVariable String enfermedadId, @RequestBody ActualizarEnfermedadDTO actualizarEnfermedadDTO) {
        editHandler.execute(enfermedadId, actualizarEnfermedadDTO);
