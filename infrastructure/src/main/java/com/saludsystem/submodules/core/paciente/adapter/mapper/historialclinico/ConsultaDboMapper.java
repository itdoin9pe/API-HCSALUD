...
public class ConsultaDboMapper
{
	...
	{
		return new Consulta(entity.getPacienteConsultaId(), entity.getPacienteEntity().getPacienteId(),
				entity.getEspecialidadEntity().getEspecialidadId(), entity.getMotivoConsulta(),
				entity.getDiagnosticoPresuntivo(), entity.isTieneAlergia(), entity.getTieneAlergiaTexto(),
				entity.isTomaMedicamento(), entity.getTomaMedicamentoTexto(), entity.isCirugiasPrevias(),
				entity.getCirugiasPreviasTexto(), entity.getEnfermedadesCronicas(), entity.isTransfusionesSanguineas(),
				entity.isHistorialPsiquiatrico(), entity.isFuma(), entity.isConsumeAlcohol(),
				entity.getActividadFisica(), entity.isEmbarazada(), entity.getUltimaMenstruacion());
	}
}