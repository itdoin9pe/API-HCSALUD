...
public class InterconsultaQueryController {
    ...
    public InterconsultaQueryController(InterconsultaListHandler listHandler, InterconsultaByIdHandler byIdHandler, InterconsultaAllHandler allHandler) {
    ...
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200",
                    ...
                    schema = @Schema(implementation = InterconsultaDTO.class)))
    })
    public ListResponse<InterconsultaDTO> getAll(@RequestParam UUID hospitalId,
