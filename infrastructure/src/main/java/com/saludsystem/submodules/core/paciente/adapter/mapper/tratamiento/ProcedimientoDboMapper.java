...
public class ProcedimientoDboMapper
{
	...
	{
		return new Procedimiento(entity.getProcedimientoId(), entity.getPacienteEntity().getPacienteId(),
				entity.getDoctorEntity().getDoctorId(), entity.getTipoProcedimiento(), entity.getDescripcion(),
				entity.getFecha(), entity.getResultado());
	}
}
