...
public class DoctorQueryController
{
	...
	public DoctorQueryController(
		DoctorAllHandler allHandler,
		DoctorByIdHandler byIdHandler,
		DoctorListHandler listHandler)
	{
	...
	@GetMapping("/GetAll")
	@ApiResponses(value =
	{ @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Operación exitosa", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DoctorListResponse.class))) })
