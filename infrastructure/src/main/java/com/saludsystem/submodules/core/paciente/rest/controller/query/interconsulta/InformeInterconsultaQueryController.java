...
public class InformeInterconsultaQueryController
{
	...
	public InformeInterconsultaQueryController(
		InformeInterconsultaListHandler listHandler,
		InformeInterconsultaByIdHandler byIdHandler,
		InformeInterconsultaAllHandler allHandler)
	{
	...
	@GetMapping("/GetAll")
	@ApiResponses(value =
	{ @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Operación exitosa", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InformeInterconsultaListResponse.class))) })
	public ListResponse<InformeInterconsultaDTO> getAll(
