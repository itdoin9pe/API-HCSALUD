...
public class UsuarioQueryController
{
	...
	public UsuarioQueryController(
		UsuarioByIdHandler byIdHandler,
		UsuarioAllHandler allHandler,
		UsuarioListHandler listHandler)
	{
	...
	@ApiResponses(value =
	{ @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Operación exitosa", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UsuarioListResponse.class))) })
