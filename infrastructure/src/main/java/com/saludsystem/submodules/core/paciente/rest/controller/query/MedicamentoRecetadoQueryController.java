...
public class MedicamentoRecetadoQueryController {
    ...
    public MedicamentoRecetadoQueryController(MedicamentoRecetadoListHandler listHandler, MedicamentoRecetadoByIdHandler byIdHandler, MedicamentoRecetadoAllHandler allHandler) {
