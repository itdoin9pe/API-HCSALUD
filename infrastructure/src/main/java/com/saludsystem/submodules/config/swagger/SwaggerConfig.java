    ...
    public OpenApiCustomizer sortOperationsByHttpMethodAndGroup() {
        return openApi -> {
            ...
            openApi.getPaths().forEach((path, pathItem) -> {
                ...
                if (pathItem.getPost() != null) orderedOperations.put(PathItem.HttpMethod.POST, pathItem.getPost());
                if (pathItem.getGet() != null) orderedOperations.put(PathItem.HttpMethod.GET, pathItem.getGet());
                if (pathItem.getPut() != null) orderedOperations.put(PathItem.HttpMethod.PUT, pathItem.getPut());
                if (pathItem.getDelete() != null) orderedOperations.put(PathItem.HttpMethod.DELETE, pathItem.getDelete());
