...
public class TipoDocumentoMapper
{
	...
	{
		return new TipoDocumentoDTO(model.getId(), model.getTipoComprobante(), model.getSerie(), model.getInicio(),
				model.getFin(), model.getCorrelativoActual(), model.getEstado());
	}
}