...
public class ProductoMapper {
    ...
    public Producto fromCreateDto(ProductoCreateCommand createCommand) {
        return new Producto(null, createCommand.getMarcaMaterialesId(), createCommand.getTipoMaterialId(),
                ...
                createCommand.getCodigo(), createCommand.getNombre(), createCommand.getDescripcion(),
                createCommand.getPrecioCompra(), createCommand.getPrecioVenta(), createCommand.getStock(),
                createCommand.getLote(), createCommand.getFecha(), createCommand.getEstadoVenta(),
                createCommand.getEstadoCompra(), createCommand.getEstadoProducto());
    }
    ...
    public Producto fromUpdateDto(UUID uuid, ProductoEditCommand editCommand) {
        return new Producto(uuid, editCommand.getMarcaMaterialesId(), editCommand.getTipoMaterialId(),
                ...
                editCommand.getCodigo(), editCommand.getNombre(), editCommand.getDescripcion(),
                editCommand.getPrecioCompra(), editCommand.getPrecioVenta(), editCommand.getStock(),
    ...
    public ProductoDTO toDto(Producto model) {
        return new ProductoDTO(model.getId(), model.getMarcaId(), model.getTipoMaterialId(),
                model.getUnidadId(), model.getPresentacionId(), model.getCategoriaMatId(),
                model.getCodigo(), model.getNombre(), model.getDescripcion(),
                model.getPrecioCompra(), model.getPrecioVenta(), model.getStock(),
                model.getLote(), model.getFecha(), model.getEstadoVenta(),
                model.getEstadoCompra(), model.getEstadoProducto());
    }
