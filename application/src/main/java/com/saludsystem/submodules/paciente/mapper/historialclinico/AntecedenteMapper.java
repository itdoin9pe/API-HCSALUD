...
public class AntecedenteMapper
{
	...
	{
		return new Antecedente(uuid, editCommand.getPacienteId(), editCommand.getMotivo(), editCommand.getEnfermedad(),
				editCommand.getTiempoEnfermedad(), editCommand.getSigno(), editCommand.getRelato(),
				editCommand.getFunciones(), editCommand.getAntecedentesPersonales(),
	...
	public AntecedenteDTO toDto(Antecedente model)
	{
		return new AntecedenteDTO(
				...
				model.getPacienteEnfermedadActualId(), model.getPacienteId(), model.getMotivo(), model.getEnfermedad(),
				model.getTiempoEnfermedad(), model.getSigno(), model.getRelato(), model.getFunciones(),
				model.getAntecedentesPersonales(), model.getAntecedentesFamiliares(), model.getMedicamento(),
				model.getNombreMedicamento(), model.getMotivoMedicamento(), model.getDosis()
		);
	}
}