...
public class MedicamentoRecetadoAllHandler {
    ...
    public MedicamentoRecetadoAllHandler(MedicamentoRecetadoDao medicamentoRecetadoDao, MedicamentoRecetadoMapper medicamentoRecetadoMapper) {
    ...
    public ListResponse<MedicamentoRecetadoDTO> execute(UUID hospitalId, PaginationRequest paginationRequest) {
        ...
        var result = medicamentoRecetadoDao.getAll(hospitalId, paginationRequest.getPage(), paginationRequest.getRows());

        List<MedicamentoRecetadoDTO> data = result.getData()
                .stream()
