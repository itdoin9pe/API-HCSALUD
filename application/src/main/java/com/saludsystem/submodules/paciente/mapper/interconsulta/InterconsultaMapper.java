...
public class InterconsultaMapper
{
	...
	{
		return new Interconsulta(null, createCommand.getPacienteId(), createCommand.getMedicoSolicitante(),
				createCommand.getEspecialidadDestino(), createCommand.getMotivo(), createCommand.getFechaSolicitud(),
				createCommand.getEstado(), createCommand.getPrioridad(), createCommand.getObservaciones(),
				createCommand.getFechaAtencion());
	}
	...
	public Interconsulta fromUpdateDto(UUID uuid, InterconsultaEditCommand editCommand)
	{
		return new Interconsulta(uuid, editCommand.getPacienteId(), editCommand.getMedicoSolicitante(),
				editCommand.getEspecialidadDestino(), editCommand.getMotivo(), editCommand.getFechaSolicitud(),
				editCommand.getEstado(), editCommand.getPrioridad(), editCommand.getObservaciones(),
				editCommand.getFechaAtencion());
	}
	...
	public InterconsultaDTO toDto(Interconsulta model)
	{
		return new InterconsultaDTO(model.getPacienteInterconsultaId(), model.getPacienteId(),
				...
				model.getFechaSolicitud(), model.getEstado(), model.getPrioridad(), model.getObservaciones(),
				model.getFechaAtencion());
	}
}