...
public class InformeInterconsultaAllHandler {
    ...
    public InformeInterconsultaAllHandler(InformeInterconsultaDao informeInterconsultaDao,
    ...
    public ListResponse<InformeInterconsultaDTO> execute(UUID hospitalId, PaginationRequest paginationRequest) {
        ...
        var result = informeInterconsultaDao.getAll(hospitalId,
                paginationRequest.getPage(), paginationRequest.getRows());

        List<InformeInterconsultaDTO> data = result.getData()
                .stream()
