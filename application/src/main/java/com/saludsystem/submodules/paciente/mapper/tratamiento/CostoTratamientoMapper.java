...
public class CostoTratamientoMapper
{
	...
	{
		return new CostoTratamiento(null, createCommand.getPacienteId(), createCommand.getPacientePlanTratamientoId(),
				createCommand.getConcepto(), createCommand.getMonto(), createCommand.getMoneda(),
				createCommand.isPagado());
	}

	public CostoTratamiento fromUpdateDto(UUID uuid, CostoTratamientoEditCommand editCommand)
	{
		return new CostoTratamiento(uuid, editCommand.getPacienteId(), editCommand.getPacientePlanTratamientoId(),
				editCommand.getConcepto(), editCommand.getMonto(), editCommand.getMoneda(), editCommand.isPagado());
	}

	public CostoTratamientoDTO toDto(CostoTratamiento model)
	{
		return new CostoTratamientoDTO(model.getPacienteCostoTratamientoId(), model.getPacienteId(),
				model.getPlanTratamientoId(), model.getConcepto(), model.getMonto(), model.getMoneda(),
				model.isPagado());
	}
}