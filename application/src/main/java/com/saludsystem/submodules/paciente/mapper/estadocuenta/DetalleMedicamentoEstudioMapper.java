...
public class DetalleMedicamentoEstudioMapper
{
	...
	{
		return new DetalleMedicamentoEstudio(null, createCommand.getPacienteId(), createCommand.getEstadoCuentaId(),
				createCommand.getTipo(), createCommand.getDescripcion(), createCommand.getCantidad(),
				createCommand.getCostoUnitario(), createCommand.getTotalCosto());
	}
	...
	{
		return new DetalleMedicamentoEstudioDTO(model.getPec_detalleMedicamentoId(), model.getPacienteId(),
				model.getEstadoCuentaId(), model.getTipo(), model.getDescripcion(), model.getCantidad(),
				model.getCostoUnitario(), model.getTotalCosto());
	}
}