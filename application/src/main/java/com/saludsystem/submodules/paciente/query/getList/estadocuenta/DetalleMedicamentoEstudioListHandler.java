...
public class DetalleMedicamentoEstudioListHandler {
    ...
    public DetalleMedicamentoEstudioListHandler(DetalleMedicamentoEstudioDao detalleMedicamentoEstudioDao, DetalleMedicamentoEstudioMapper detalleMedicamentoEstudioMapper) {
    ...
    public List<DetalleMedicamentoEstudioDTO> execute() {
        ...
        return detalleMedicamentoEstudioList.stream()
