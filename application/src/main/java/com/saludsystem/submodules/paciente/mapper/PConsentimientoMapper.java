...
public class PConsentimientoMapper {
    ...
    public PacienteConsentimiento fromCreateDto(PConsentimientoCreateCommand createCommand) {
        ...
        if (horaDTO != null) {
            // Supongamos que HoraDTO tiene getHora() y getMinuto()
        ...
        return new PacienteConsentimiento(
                ...
                createCommand.getConsentimientoId(),
                createCommand.getCuerpo(),
                createCommand.getFecha(),
                hora,
                createCommand.getApoderadoNombre(),
                createCommand.getApoderadoDocumento(),
                createCommand.getApoderadoDireccion(),
                createCommand.getDoctorId(),
                createCommand.getEstado(),
                createCommand.getFirma()
        );
    }
    ...
    public PacienteConsentimiento fromUpdateDto(UUID uuid, PConsentimientoEditCommand editCommand) {
        ...
        return new PacienteConsentimiento(uuid,
                editCommand.getPacienteId(),
                editCommand.getConsentimientoId(),
                editCommand.getCuerpo(),
                editCommand.getFecha(),
                hora,
                editCommand.getApoderadoNombre(),
                editCommand.getApoderadoDocumento(),
                editCommand.getApoderadoDireccion(),
                editCommand.getDoctorId(),
                editCommand.getEstado(),
                editCommand.getFirma()
        );
    ...
    public PConsentimientoDTO toDto(PacienteConsentimiento model) {
        ...
        return new PConsentimientoDTO(
                model.getPacienteConsentimientoId(),
                model.getPacienteId(),
                model.getConsentimientoId(),
                model.getCuerpo(),
                model.getFecha(),
                horaDTO,
                model.getApoderadoNombre(),
                model.getApoderadoDocumento(),
                model.getApoderadoDireccion(),
                model.getDoctorId(),
                model.getEstado(),
                model.getFirma()
        );
