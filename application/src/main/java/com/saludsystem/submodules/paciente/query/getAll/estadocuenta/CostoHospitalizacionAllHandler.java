...
public class CostoHospitalizacionAllHandler {
    ...
    public CostoHospitalizacionAllHandler(CostoHospitalizacionDao costoHospitalizacionDao, CostoHospitalizacionMapper costoHospitalizacionMapper) {
    ...
    public ListResponse<CostoHospitalizacionDTO> execute(UUID hospitalId, PaginationRequest paginationRequest) {
        ...
        var result = costoHospitalizacionDao.getAll(hospitalId, paginationRequest.getPage(), paginationRequest.getRows());

        List<CostoHospitalizacionDTO> data = result.getData()
                .stream()
