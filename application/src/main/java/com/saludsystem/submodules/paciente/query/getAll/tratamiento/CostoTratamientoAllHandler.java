...
public class CostoTratamientoAllHandler {
    ...
    public CostoTratamientoAllHandler(CostoTratamientoDao costoTratamientoDao, CostoTratamientoMapper costoTratamientoMapper) {
    ...
    public ListResponse<CostoTratamientoDTO> execute(UUID hospitalId, PaginationRequest paginationRequest) {
        ...
        List<CostoTratamientoDTO> data = result.getData()
                .stream()
