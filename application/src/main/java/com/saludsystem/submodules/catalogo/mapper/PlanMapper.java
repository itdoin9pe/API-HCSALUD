...
public class PlanMapper
{
	...
	{
		return new Plan(null, dto.getNombrePlan(), dto.getFechaInicio(), dto.getFechaFinContrato(), dto.getMaxPlan(),
				dto.getUseMax(), dto.getCostoPlan(), dto.getEstado());
	}

	public Plan fromUpdateDto(UUID uuid, PlanEditCommand dto)
	{
		return new Plan(uuid, dto.getNombrePlan(), dto.getFechaInicio(), dto.getFechaFinContrato(), dto.getMaxPlan(),
				dto.getUseMax(), dto.getCostoPlan(), dto.getEstado());
	}
