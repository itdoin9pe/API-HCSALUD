...
public class CuentaMapper
{
	...
	{
		return new Cuenta(null, createCommand.getNombre(), createCommand.getTotal(), createCommand.getEstado());
	}

	public Cuenta fromUpdateDto(UUID uuid, CuentaEditCommand editCommand)
	{
		return new Cuenta(uuid, editCommand.getNombre(), editCommand.getTotal(), editCommand.getEstado());
	}
