...
import com.saludsystem.paciente.infrastructure.adapters.in.response.HistorialClinico.ConsultaResponse;
...
public class ConsultaController extends GenericController<CrearConsultaDTO, ConsultaDTO, UUID> {

    protected ConsultaController(GenericService<CrearConsultaDTO, ConsultaDTO, UUID> genericService) {
