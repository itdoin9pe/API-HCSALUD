...
@Service
public class TarifarioServiceImpl extends GenericServiceImpl<TarifarioEntity, TarifarioDTO, CrearTarifarioDTO,
        ActualizarTarifarioDTO, UUID> implements TarifarioService {
