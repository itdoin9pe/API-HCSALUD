package com.saludSystem.infraestructura.controllers.ModuleDoctor;
...
import com.saludSystem.aplicacion.dtos.responses.Doctor.DoctorResponse;
...
import com.saludSystem.aplicacion.services.FileStorageService;
...
public class DoctorController {
    ...
    public ResponseEntity<ApiResponse> updateDoctor(
        ...
        if (fotoDoctor != null && !fotoDoctor.isEmpty()) {
            Doctor doctorExistente = doctorRepository.findById(doctorId).orElseThrow();
