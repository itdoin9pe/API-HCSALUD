package com.saludSystem.Configuracion.Usuario.aplicacion.services.impl;
...
import com.saludSystem.Configuracion.Usuario.aplicacion.services.UsuarioService;
...
public class UsuarioServiceImpl implements UsuarioService {
    ...
    public ListResponse<UsuarioDTO> getAllUsuario(UUID hospitalId, int page, int rows) {
        ...
        Page<UserModel> userPage = userRepository.findByHospital_HospitalId(hospitalId, pageable);
    ...
    @Override
    public UserModel saveUsuario(NewUserDto newUserDto) {
        RoleModel role = roleRepository.findByRoleId(newUserDto.getRoleId())
                .orElseThrow(() -> new EntityNotFoundException("Rol no encontrado"));
        SysSaludModel hospital = sysSaludRepository.findAll()
    ...
    private UsuarioDTO convertToDTO(UserModel user) {
