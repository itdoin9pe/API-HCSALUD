package com.saludSystem.Medico.infraestructura.controller;
...
import com.saludSystem.Medico.dominio.DoctorResponse;
...
public class DoctorController {
    ...
    public ResponseEntity<ApiResponse> updateDoctor(
        ...
        if (fotoDoctor != null && !fotoDoctor.isEmpty()) {
            DoctorModel doctorExistente = doctorRepository.findById(doctorId).orElseThrow();
