...
public class MedicamentoConstant {
    ...
    public static final String ID_NOT_FOUND = "Id del registro de Medicamento no encontrado correctamente";
    public static final String INVALID_ID = "Id del registro de Medicamento no puede ser null";
