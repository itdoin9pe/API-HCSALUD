package com.saludsystem.submodules.mantenimiento.model.validators;
...
public class TarifarioValidator {
    ...
    public void validateForCreation(CrearTarifarioDTO dto) {
        validateNotNull(dto);
        validateRequiredFields(dto);
        validateBusinessRules(dto);
    }

    public void validateForUpdate(UUID id, ActualizarTarifarioDTO dto) {
        validateNotNull(dto);
    ...
    private void validateRequiredFields(CrearTarifarioDTO dto) {
    ...
    private void validateRequiredFields(ActualizarTarifarioDTO dto) {
        var errors = new ArrayList<String>();
    ...
    private void validateBusinessRules(CrearTarifarioDTO dto) {
    ...
    // Sobrecarga para ActualizarTarifarioDTO
    private void validateBusinessRules(ActualizarTarifarioDTO dto) {
        validatePrecio(dto.getPrecio());
        validateEstado(dto.getEstado());
        validateDescripcion(dto.getDescripcion());
        validateGrupo(dto.getGrupo());
