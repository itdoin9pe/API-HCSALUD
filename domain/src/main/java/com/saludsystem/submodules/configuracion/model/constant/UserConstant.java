...
public class UserConstant {
    ...
    public static final String ID_NOT_FOUND = "No se encontro el ID del usuario";
    public static final String CREATED = "Usuario creado correctamente";
    public static final String UPDATED = "Usuario actualizado correctamente";
    public static final String DELETED = "Usuario eliminado correctamente";
}
